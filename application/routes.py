...
# courseData = [{"courseID": "1111", "title": "PHP 111", "description": "Intro to PHP", "credits": "3", "term": "Fall, Spring"}, {"courseID": "2222", "title": "Java 1", "description": "Intro to Java Programming", "credits": "4", "term": "Spring"}, {"courseID": "3333", "title": "Adv PHP 201", F"description": "Advanced PHP Programming", "credits": "3", "term": "Fall"}, {"courseID": "4444", "title": "Angular 1", "description": "Intro to Angular", "credits": "3", "term": "Fall, Spring"}, {"courseID": "5555", "title": "Java 2", "description": "Advanced Java Programming", "credits": "4", "term": "Fall"}]
...
class GetUpdateDelete(Resource):
    ...
    def delete(self, idx):
        ...
        return jsonify(f"User with index:{idx} is deleted")
...
def courses(term="Spring 2019"):
    ...
    classes = Course.objects.order_by("+courseID")  # + sign for ascending order, - sign for descending order
...
def enrollment():
    ...
    if courseID:
        if Enrollment.objects(user_id=user_id, courseID=courseID):
            flash(f"Oops! You are already registered in this course called {courseTitle}!", "danger")
...
# Return static data defined on this page
# @app.route("/api/")
# @app.route("/api/<idx>")
# def api(idx=None):  # idx will be None if first route is used
#     if (idx == None):
#         jdata = courseData
#     else:
